 ...
 */
final class Version20200513170510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rooms ADD game_type VARCHAR(255) DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE password password VARCHAR(255) DEFAULT NULL, CHANGE current_deck current_deck LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE used_deck used_deck LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
